...
export const logout = () => async(dispatch) =>{
    try{
       ...
       await axios.get(`https://ecommerce-website-nuyo.onrender.com/api/v1/logout`);
...
export const updatePassword = (passwords) => async (dispatch) => {
  ...
  export const getAllUsers = () => async (dispatch) => {
    try {
      ...
      const { data } = await axios.get(`https://ecommerce-website-nuyo.onrender.com/api/v1/admin/users`);
  ...
  export const deleteUser = (id) => async (dispatch) => {
    try {
      ...
      const { data } = await axios.delete(`https://ecommerce-website-nuyo.onrender.com/api/v1/admin/user/${id}`);
...
export const getUserDetails = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`https://ecommerce-website-nuyo.onrender.com/api/v1/admin/user/${id}`);
